...
// configuration step. It creates a namespace called `_tmyproj_`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", _tmyproj_::cmake::project_name, _tmyproj_::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", _tmyproj_::cmake::project_version);
      return EXIT_SUCCESS;
    }
